...
SECRET_KEY = 'django-insecure-k9o85d5cgrkettyeug+m66@33q#xg32b0t9b3qnstt3)99)7@e'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'my_django_project',        # Your database name
        'USER': 'django_user',              # Your MySQL user
        'PASSWORD': 'djangoproject',      # The password for the user
